...
자이로ON:
    ...
    '***********************************************
자이로_다리측면_ON:
    GYROSENSE G6A,200,1,1,1,0
    GYROSENSE G6D,200,1,1,1,0
    GYROSET G6A, 4, 3, 3, 3, 0
    GYROSET G6D, 4, 3, 3, 3, 0
...
후진앉아보행:
    ...
    MOVE G6B,170,  30,  80,
    MOVE G6C,170,  30,  80,
    MOVE G6A,98, 148,  23, 150,  102, 100
    MOVE G6D, 98, 148,  23, 150, 102, 100
    WAIT
...
후진앉아보행_1:
    ...
    MOVE G6D,115, 148,  23, 152,  96, 100
    MOVE G6A, 85, 148,  23, 150, 110, 100
    WAIT
    SPEED 8
    MOVE G6D,98, 138,  23, 162,  102, 100
    MOVE G6A, 98, 168,  23, 130, 102, 100
    WAIT
...
후진앉아보행_2:
    SPEED 8
    MOVE G6A,115, 148,  23, 152,  96, 100
    MOVE G6D, 85, 148,  23, 150, 110, 100
    WAIT
    SPEED 8
    MOVE G6A,98, 135,  23, 162,  102, 100
    MOVE G6D, 98, 168,  23, 130, 102, 100
    WAIT
